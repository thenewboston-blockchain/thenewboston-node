...
echo 'Not implemented: use initialize_blockchain'
false
poetry run python -m thenewboston_node.manage start_node ${START_NODE_ARGS} ${ARF_URL} --failover-blockchain-genesis-state-source ${ARF_PATH}

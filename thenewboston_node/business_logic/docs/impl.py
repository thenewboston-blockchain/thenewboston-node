...
def get_context(samples_factory):
    ...
    return {
        ...
        'blocks': samples_factory.get_sample_blocks(),
        'blockchain_state': samples_factory.get_sample_blockchain_state(),
        'block_types': {item.value: humanize_snake_case(item.name.lower()) for item in BlockType},
        'file_blockchain': samples_factory.get_sample_blockchain(),

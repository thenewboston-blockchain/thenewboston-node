...
def get_request_to_block_type_map():
    from thenewboston_node.business_logic.algorithms.updated_account_states import (
        get_updated_account_states_for_coin_transfer, get_updated_account_states_for_network_address_registration
    )
    ...
    return {
        ...
        NodeDeclarationSignedChangeRequest: (
            BlockType.NETWORK_ADDRESS_REGISTRATION.value, get_updated_account_states_for_network_address_registration
        ),
    }

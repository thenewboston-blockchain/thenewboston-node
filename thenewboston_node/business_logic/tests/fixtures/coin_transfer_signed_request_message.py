...
def sample_coin_transfer_signed_request_message(
    treasury_account_key_pair, user_account_key_pair, preferred_node_key_pair, primary_validator_key_pair
):
    return CoinTransferSignedChangeRequestMessage(
        ...
        txs=[
            ...
            CoinTransferTransaction(amount=1, recipient=preferred_node_key_pair.public, is_fee=True),

...
def test_blockchain_blockchain_genesis_state_is_validated(blockchain_base):
    ...
    with patch.object(blockchain_base, 'yield_blockchain_states', get_generator([initial_arf])):
...
def test_blockchain_without_blockchain_genesis_state_is_validated(blockchain_base):
    ...
    with patch.object(blockchain_base, 'yield_blockchain_states', get_generator([non_initial_arf])):

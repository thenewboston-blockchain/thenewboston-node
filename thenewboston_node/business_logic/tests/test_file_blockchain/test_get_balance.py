...
def add_block(blockchain, user_account, treasury_account_signing_key, preferred_node):
...
def test_can_get_account_state(file_blockchain, user_account, treasury_account_signing_key, preferred_node):
    add_block(file_blockchain, user_account, treasury_account_signing_key, preferred_node)

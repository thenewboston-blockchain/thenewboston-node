...
def set_up(file_blockchain_w_memory_storage, user_account, treasury_account_signing_key, preferred_node):
    ...
    blockchain.get_block_chunk_storage().append(filename, block0.to_messagepack())
    ...
    blockchain.get_block_chunk_storage().append(filename, block1.to_messagepack())
    ...
    blockchain.get_block_chunk_storage().append(filename, block2.to_messagepack())
    ...
    blockchain.get_block_chunk_storage().append(filename, block3.to_messagepack())

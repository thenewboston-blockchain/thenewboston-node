...
def test_can_get_nodes_single_node_from_blockchain_genesis_state(
    ...
    blockchain_genesis_state.message.account_states[account_number] = AccountState(node=node)
...
def test_can_get_nodes_from_genesis_state_and_blocks(
    ...
    blockchain_genesis_state.message.account_states[key_pair.public] = AccountState(node=blockchain_state_node)
...
def test_can_get_nodes_blocks_node_overrides_genesis_state_node(
    ...
    blockchain_genesis_state.message.account_states[account_number] = AccountState(node=blockchain_state_node)
...
def test_can_get_nodes_from_complex_blockchain(blockchain_directory, blockchain_genesis_state):
    ...
    blockchain_genesis_state.message.account_states[node1.identifier] = AccountState(node=node1)
    blockchain.add_blockchain_state(blockchain_genesis_state)
    blockchain.validate()

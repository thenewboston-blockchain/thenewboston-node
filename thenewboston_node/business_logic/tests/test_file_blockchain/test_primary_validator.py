...
def test_can_get_pv_from_blockchain_genesis_state(
    ...
    blockchain_genesis_state.message.account_states[account_number] = AccountState(
...
def test_can_get_overridden_pv(blockchain_directory, blockchain_genesis_state, user_account_key_pair):
    ...
    blockchain_genesis_state.message.account_states[another_key_pair.public] = AccountState(node=another_node)

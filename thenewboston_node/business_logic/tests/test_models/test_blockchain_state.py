...
def test_normalized_blockchain_state(blockchain_genesis_state):
    assert blockchain_genesis_state.get_normalized() == (
        b'{"message":{"account_states":{"4d3cf1d9e4547d324de2084b568f807ef12045075a7a01b8bec1e7f013fc3732":'
        b'{"balance":281474976710656},"b9dc49411424cce606d27eeaa8d74cb84826d8a1001d17603638b73bdc6077f1":'
        b'{"node":{"fee_amount":4,"network_addresses":["http://pv.non-existing-domain:8555/"]},'
